...
public class PagerTag extends SimpleTagSupport {
	...
	public void setPageIndex(int pageIndex) {
		System.out.println("init pageindex="+pageIndex);
		this.pageIndex = pageIndex;
	}
	public void setPageSize(int pageSize) {
		System.out.println("init pageSize="+pageSize);
		this.pageSize = pageSize;
	}
	public void setRecordCount(int recordCount) {
		System.out.println("init recordCount="+recordCount);
		this.recordCount = recordCount;
	}
	public void setSubmitUrl(String submitUrl) {
		System.out.println("init submitUrl="+submitUrl);
		this.submitUrl = submitUrl;
	}
	public void setStyle(String style) {
		System.out.println("init style="+style);
		this.style = style;
	}
}